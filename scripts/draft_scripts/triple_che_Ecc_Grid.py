...
#             eps_SA1 = epsilon_sa(m1, m2, m3[i], a1_in_au, a2[j], 0)
#             eps_GR1 = epsilon_gr(m1, m2, m3[i], a1_in_au, a2[j], 0)
#             eps_Tide1 = epsilon_tide(m1, m2, m3[i], a1_in_au, a2[j], 0, r1, r2, k1, k2)
        
#             ecc_grid[i][j] = get_maximal_eccentricity(m1, m2, m3[i], a1_in_au, a2[j], 0, eps_SA1, eps_GR1, eps_Tide1, cos_inc, debug)
#             etas[i][j] = eta(m1, m2, m3[i], a1_in_au, a2[j], 0)
...
# %%
# "tau_ZKL":tau_ZKL, "ETA":ETA, "eps_SA":eps_SA, "eps_GR":eps_GR, "eps_Tides":eps_Tides
...
mdic = {"m3":m3, "p2":p2, "eccs":ecc_grid, "cos_inc_max_ecc":cos_inc_max_ecc}
scipy.io.savemat(string_to_save, mdic)
