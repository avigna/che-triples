function plot_GW_merger_timescale_analysis_final(debug_flag, annotations_flag, save_flag)
...
angle = 11;
if indx_plot==1
    text(2.25,26,leveler,'He Merger','Color','k','Fontsize',fs, 'Rotation', angle)
    text(text_x_coord,8,leveler,'Main-Sequence Merger','Color','w','Fontsize',fs)
elseif indx_plot==2
    text(4,20,leveler,'He Merger','Color','k','Fontsize',fs, 'Rotation', angle)
