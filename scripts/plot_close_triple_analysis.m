...
% Choose
list_binary = {'55+55 CHE ZAMS low Z','55+55 CHE HeMS low Z','55+55 CHE end low Z','55+55 CHE ZAMS Z_SMC','55+55 CHE HeMS Z_SMC','55+55 CHE end Z_SMC','TIC 470710327 full','TIC 470710327 GR'};
...
elseif indx_binary==2
    ...
    plot_label_temp_png = '../plots/png/55_Msun_low_Z/CHE-HeMS-close-triple-analysis_';
    plot_label_temp_pdf = '../plots/pdf/55_Msun_low_Z/CHE-HeMS-close-triple-analysis_';    
...
elseif indx_binary==3
    ...
    plot_label_temp_png = '../plots/png/55_Msun_low_Z/CHE-end-close-triple-analysis_';
    plot_label_temp_pdf = '../plots/pdf/55_Msun_low_Z/CHE-end-close-triple-analysis_';    
...
elseif indx_binary==4
    ...
    plot_label_temp_png = '../plots/png/55_Msun_Z_SMC/CHE-ZAMS-close-triple-analysis_';
    plot_label_temp_pdf = '../plots/pdf/55_Msun_Z_SMC/CHE-ZAMS-close-triple-analysis_';    
...
elseif indx_binary==5
    ...
    title_string        = ['$m_1=m_2=55\ M_{\odot},\ P_{\rm{orb}}=1.1\ d,\ Z=0.0035/ \rm{at\ HeMS}$'];
    plot_label_temp_png = '../plots/png/55_Msun_Z_SMC/CHE-HeMS-close-triple-analysis_';
    plot_label_temp_pdf = '../plots/pdf/55_Msun_Z_SMC/CHE-HeMS-close-triple-analysis_';    
